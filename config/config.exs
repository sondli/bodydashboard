...
config :bodydashboard,
  ecto_repos: [Bodydashboard.Repo],
...
config :bodydashboard, BodydashboardWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BodydashboardWeb.ErrorHTML, json: BodydashboardWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Bodydashboard.PubSub,
  live_view: [signing_salt: "5lcs1cuf"]
